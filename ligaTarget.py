...
def ligaTarget():
    #strLigaTarget = "Production"      #set to use koelnrausch.de
    #strLigaTarget = "ProductionAWS"      #set to use aws
    strLigaTarget = "ProductionAWS_VPN"      #set to use aws
    #strLigaTarget = "DebugMacBook"  #set to use debug localhost on MacBook
    if (bDebug):
